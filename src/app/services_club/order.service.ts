...
export class OrderService {
  ...
  private apiUrl = "https://weshoot-api-50021575749.development.catalystappsail.in/we-shoot/order"
  ...
  checkPostStatus(): Observable<String> {
    return this.http.post<String>("https://weshoot-api-50021575749.development.catalystappsail.in/we-shoot/check","");
  }
}
